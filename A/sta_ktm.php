...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="sta_ktm.php">Surat KTM Sementara</a></li>
  </ul>
</div>

<div class="container-fluid">
<div class="card">
  <div class="card-header text-center">Statistik Permintaan Surat KTM Sementara</div>
  <div class="card-body">

    <div class="row">
        <?php 
            $sql="SELECT * FROM surat WHERE jenis='2'";
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            Total Permintaan Surat Aktif Kuliah</div>
        ...
        <?php 
            $sqlp="SELECT * FROM surat WHERE jenis='2' AND ttd='ttd.png'";
        ...
        <?php 
            $sqlb="SELECT * FROM surat WHERE jenis='2' AND ttd=''";
