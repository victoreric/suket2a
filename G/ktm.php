...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="ktm.php">KTM Sementara</a></li>
  </ul>
</div>

<div class="container">
<div class="card">
  <div class="card-header text-center">Permohonan Surat Keterangan Kartu Tanda Mahasiswa Sementara</div>
  <div class="card-body">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <select name="jenis" id="jenis" class="form-control" readonly>
                        <?php
                        $jenisqueri="SELECT * FROM jenis_suket WHERE id_jenis='2'";
                ...
                <div class="form-group">
                    <label for="tujuan" class="form-control-label">Tujuan permohonan surat keterangan KTM sementara, untuk:</label>
...
if(isset($_POST['simpan'])){
    ...
    {
        $query="INSERT INTO surat (nim, nama, prodi, semester, thnakd,ortu, pekerjaan, nip, pangkat, jenis, tujuan, ukt, krs, dns, kk, skortu,ttd,cap) VALUES ('$nim','$nama','$prodi','$semester','$thnakd','','','','','$jenis','$tujuan','$uktfile','$krsfile','$dnsfile','$kkfile','','','')";
